...
struct token
{
    ...
    // it signify if there is a whitespace between this token and next
    // token
    // i.e. * a for operator token * would be mean whitespace is true for token a
    bool whitespace;

    // (true when is inside backets)
    // This is for debug
 ...
 struct lex_process
 {
    ...
    */
    ...
    // This will be private data that the lexed does not understand
